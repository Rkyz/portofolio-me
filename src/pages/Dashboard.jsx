        ...
        <div className='flex flex-col gap-[60px]'>
         ...
         <div className='bg-[#212023] w-full h-auto rounded-lg p-[25px] gap-[15px] flex flex-col items-start font-poppins text-white'>
            ...
            <div className='bg-[#212023] p-[25px] rounded-lg flex gap-[25px] max-sm:flex-col'>
                <div className='max-md:w-full w-[120px] h-[90px] bg-black bg-cover' style={{ backgroundImage: `url(${foto})` }}/>
            ...
            <div className='bg-[#212023] p-[25px] rounded-lg flex gap-[25px] max-sm:flex-col'>
                <div className='max-md:w-full w-[120px] h-[90px] bg-black bg-cover' style={{ backgroundImage: `url(${foto1})` }}/>
                <div className='capitalize text-white flex flex-col'>
