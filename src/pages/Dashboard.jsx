      ...
      <div className='flex flex-col gap-[20px] mlg:pl-[calc(50%+10px)] max-mlg:pl-[60px] max-md:py-[30px] max-md:px-[30px] py-[60px] pr-[60px] w-full'>
        <div className='flex flex-col gap-[60px]'>
         ...
         <div className='bg-[#212023] w-full h-auto rounded-lg p-[25px] gap-[15px] flex flex-col items-start font-poppins text-white'>
            ...
            <Link to="https://youtube-project-eta.vercel.app/" className='bg-[#212023] p-[25px] rounded-lg flex gap-[25px] max-sm:flex-col'>
                <div className='max-md:w-full w-[120px] max-md:h-[150px] h-[90px] bg-black bg-cover' style={{ backgroundImage: `url(${foto3})` }}/>
                <div className='capitalize text-white flex flex-col'>
                    <p className='font-medium text-[18px] text-white text-opacity-70'>youtube clone</p>
                    <p className='text-medium text-white text-opacity-50 text-[15px]'>projects cloning tampilan frontend yang mengikuti design youtube</p>
                    <div className='flex items-center gap-[10px] mt-[10px]'>
                         <div className='py-[8px] px-[15px] capitalize text-[13px] text-opacity-50 text-white rounded-full bg-white bg-opacity-5'>
                            javascript
                        </div>
            ...
            <Link to="https://kasir-frontend-ed1v.vercel.app/dashboard" className='bg-[#212023] p-[25px] rounded-lg flex gap-[25px] max-sm:flex-col'>
                <div className='max-md:w-full w-[120px] max-md:h-[150px] h-[90px] bg-black bg-cover' style={{ backgroundImage: `url(${foto4})` }}/>
                <div className='capitalize text-white flex flex-col'>
            ...
            <Link to="https://eskul-project.vercel.app/" className='bg-[#212023] p-[25px] rounded-lg flex gap-[25px] max-sm:flex-col'>
